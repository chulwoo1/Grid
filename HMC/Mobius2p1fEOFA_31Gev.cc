...
int main(int argc, char **argv) {
  ...
  typedef GenericHMCRunner<ForceGradient,ImplicitMinimumNorm2> HMCWrapper;  MD.name    = std::string("ForceGradient/ImplicitMinimumNorm2");
#if 0
  {
...
// For HMC
  ...
  // Copied from paper
  std::vector<Real> hasenbusch({ 0.05, 0.2, 0.6 }); 
