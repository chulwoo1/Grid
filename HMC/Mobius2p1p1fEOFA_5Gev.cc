...
//  typedef GenericHMCRunner<MinimumNorm2> HMCWrapper; 
  ...
  Real light_mass   = 0.000378;
  Real strange_mass = 0.0114;
  Real charm_mass = 0.1445;
  Real pv_mass    = 1.0;
  RealD M5  = 1.4;
  RealD b   = 2.0; 
  RealD c   = 1.0;
...
//  auto GridPtrF   = SpaceTimeGrid::makeFourDimGrid(latt,simdF,mpi);
  ...
  std::cout << GridLogMessage << " Grids created  " << std::endl;
...
//  IwasakiGaugeActionR GaugeAction(beta);
  ...
  std::cout << GridLogMessage << " WilsonGaugeActionR created  " << std::endl;
...
//  ActionLevel<HMCWrapper::Field> Level2(HMCparams.SW);
  ActionLevel<HMCWrapper::Field> Level2(12);
